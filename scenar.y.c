/* A Bison parser, made from scenar.y
   by GNU bison 1.35.  */
...
{
       0,     0,     4,     5,     6,     9,    10,    13,    16,    21,
      25,    27,    38,    40
};
static const short yyrhs[] =
{
      17,    19,    18,     0,     0,     0,    19,    20,     0,     0,
       7,     4,     0,     5,     4,     0,     6,     3,    14,     3,
       0,     9,     3,    10,     0,    11,     0,    12,     3,    14,
       3,    14,     3,    14,     3,    14,     3,     0,    13,     0,
      15,     4,     0
};
...
{
       0,   135,   137,   145,   150,   151,   153,   158,   162,   166,
     169,   172,   179,   182
};
#endif
...
{
  "$", "error", "$undefined.", "INTEGER", "STRING", "BACKGROUND", "VECTOR", 
  "FOREGROUND", "MUSIC", "WAIT", "SEC", "LOOP", "TEXTAREA", "NOTEXTAREA", 
  "COMMA", "SAY", "scenar", "prologue", "epilogue", "instructions", 
  "instruction", 0
};
#endif
...
{
       2,     5,     3,     0,     0,     0,     0,    10,     0,    12,
       0,     1,     4,     7,     0,     6,     0,     0,    13,     0,
       9,     0,     8,     0,     0,     0,     0,     0,     0,    11,
       0,     0,     0
};
...
{
  -32768,-32768,    -5,    -1,     2,     5,     8,-32768,     9,-32768,
      10,-32768,-32768,-32768,     1,-32768,     3,     4,-32768,    13,
  -32768,    14,-32768,     6,    16,     7,    19,    11,    20,-32768,
      24,    26,-32768
};
...
{
       3,     4,     5,    13,     6,    14,     7,     8,     9,    15,
      10,    16,    17,    20,    18,    19,    22,    23,    21,    25,
      24,    26,    27,    29,    31,    28,    32
};

static const short yycheck[] =
{
       5,     6,     7,     4,     9,     3,    11,    12,    13,     4,
      15,     3,     3,    10,     4,    14,     3,     3,    14,     3,
      14,    14,     3,     3,     0,    14,     0
};
...
{
          if(first_layer) { SDL_FreeSurface(first_layer); first_layer=0; }
          first_layer = IMG_Load_DisplayFormatAlpha(yyvsp[0].str);
        }
    break;
case 7:
#line 158 "scenar.y"
{
          if(back_layer)  { SDL_FreeSurface(back_layer);  back_layer=0;  }
          back_layer = IMG_Load_DisplayFormatAlpha(yyvsp[0].str);
        }
    break;
case 8:
#line 162 "scenar.y"
