...
PuyoCommander::PuyoCommander(bool fs, bool snd, bool audio)
{
  ...
  menuselector = IIM_Load_DisplayFormatAlpha("menusel.png");

  networkGameMenu = new PuyoNetworkGameMenuScreen(menuFont, menuselector, *this, display);
