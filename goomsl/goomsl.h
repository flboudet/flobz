...
#define GSL_GLOBAL_PTR(gsl,global,name)   gsl_get_ptr(gsl, *(int*)goom_hash_get(global,name)->ptr)
#define GSL_GLOBAL_INT(gsl,global,name)   (*(int*)goom_hash_get(global,name)->i)
#define GSL_GLOBAL_FLOAT(gsl,global,name) (*(float*)goom_hash_get(global,name)->f)
