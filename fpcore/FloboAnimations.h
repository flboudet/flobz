...
public:
    FloboAnimation(const std::weak_ptr<AnimatedFlobo> &flobo):_attachedFlobo(flobo) {}
    float getSoundPadding() const;
protected:
    std::weak_ptr<AnimatedFlobo> _attachedFlobo;
};
...
public:
    TurningAnimation(const std::weak_ptr<AnimatedFlobo> &companionFlobo, bool counterclockwise);
    void cycle();
private:
    int _cpt;
    float _angle;
...
public:
    MovingHAnimation(const std::weak_ptr<AnimatedFlobo> &flobo, int hOffset, int step);
    void cycle();
private:
...
public:
    MovingVAnimation(const std::weak_ptr<AnimatedFlobo> &flobo, int vOffset, int step);
    void cycle();
private:
...
public:
    FallingAnimation(const std::weak_ptr<AnimatedFlobo> &flobo,
...
public:
    GameOverFallAnimation(std::weak_ptr<AnimatedFlobo> flobo, int delay);
